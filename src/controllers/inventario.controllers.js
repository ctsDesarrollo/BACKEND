...
export const getInventario = async (req, resp)=> {   
    ...
    try {
        ...
        const result=await pool.request().query(queries.getInventarioTodo);
        //console.log(result)
...
export const getInventarioById = async (req, resp)=>{
    ...
    .request()
    .input('Id',id)
    .query(queries.getInventarioById);
 //console.log(result);
...
export const updateInventario = async (req, res)=>{
    ...
    if(Id_inventario==null|| Serie==null||Tipo==null|| Marca==null|| Modelo==null ||Id==null){
        ...
        try {
           ...
           .input('marca', sql.VarChar, Marca)
           .input('modelo', sql.VarChar, Modelo)
           .query(queries.updateInventario);
...
export const deleteInventarioById =async(req, res)=>{   
        ...
        .request()
        .input('Id',id)
        .query(queries.deleteInventarioById);
     // console.log(result);
        res.sendStatus(204);
